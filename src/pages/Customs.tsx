...
import { FileText, Package, Gavel, AlertTriangle } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold tracking-tight">Customs Management</h1>
          <p className="text-muted-foreground">
            Manage customs compliance, declarations, and auction processes under SRO 450(I)/2001
          </p>
        </div>
