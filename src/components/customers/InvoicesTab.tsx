...
const invoiceStats = [
  { label: "Total Invoiced", value: "$284,500", color: "text-foreground" },
  { label: "Paid", value: "$198,200", color: "text-green-600" },
  { label: "Pending", value: "$54,300", color: "text-yellow-600" },
  { label: "Overdue", value: "$32,000", color: "text-red-600" },
];
